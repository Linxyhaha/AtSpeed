...
def train(args, log=True):
    ...
    if args.model_class == "OnPolicyStrictKDModel":
        KD_args.update({
            "topK": args.topK,
            "len_y": args.len_y,
            "beta": args.beta,
    ...
    elif args.model_class == "SoftKDModel":
        KD_args.update({
            "topK": args.topK,
            "len_y": args.len_y,
            "noTopK4loss": args.noTopK4loss,
            "tau": args.tau,
            "weights": eval(args.weights),
            "topK4loss": args.topK4loss,
            "topKto1": args.topKto1,
            "topK_p_normal": args.topK_p_normal,
        })
    ...
    if args.constrained_loss:
        ...
        KD_args["allowed_tokens_dict"] = allowed_tokens_dict
        KD_args["constrained_softmax"] = args.constrained_softmax
    
        KD_args["temperature_softmax_q"] = args.temperature_softmax_q
        KD_args["temperature_softmax_p"] = args.temperature_softmax_p
        KD_args["intervention"] = args.intervention
